...
func (rs *TokenStore) Create(info oauth2.Token) (err error) {
	ct := time.Now()
...
func (rs *TokenStore) getData(key string) (ti oauth2.Token, err error) {
...
func (rs *TokenStore) GetByCode(code string) (ti oauth2.Token, err error) {
	ti, err = rs.getData(code)
	return
}

// GetByAccess Use the access token for token information data
func (rs *TokenStore) GetByAccess(access string) (ti oauth2.Token, err error) {
...
func (rs *TokenStore) GetByRefresh(refresh string) (ti oauth2.Token, err error) {
